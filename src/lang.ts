const lang = {
  ...
  'VideoChat.CreatePopup.New.Title': 'New Video Chat',
  'VideoChat.CreatePopup.New.Description': 'Choose whether you want to be displayed as your personal account or as your channel.',
  'VideoChat.CreatePopup.New.StartWith': 'Start with...',
  'VideoChat.CreatePopup.New.Start': 'Start Video Chat',
  'VideoChat.CreatePopup.New.Scheduled': 'Scheduled Video Chat',
  'VideoChat.CreatePopup.New.PickDate': 'Select',
  'VideoChat.CreatePopup.StreamWith.Title': 'Stream With...',
  'VideoChat.CreatePopup.StreamWith.Description': 'To stream video with another app, enter these\nServer URL and Stream Key in your streaming app.\nSoftware encoding recommended (×264 in OBS).',
  'VideoChat.CreatePopup.StreamWith.WaitingDescription': 'Telegram doesn\'t see any stream coming from your streaming app. Please make sure you entered the right Server URL and Stream Key in your app.',
  'VideoChat.CreatePopup.StreamWith.DescriptionBelow': 'Once you start broadcasting in your streaming app,\nclick Start Streaming below.',
  'VideoChat.CreatePopup.StreamWith.Start': 'Start Streaming',
  'VideoChat.CreatePopup.StreamWith.End': 'End Live Stream',
  'VideoChat.CreatePopup.StreamWith.Revoke': 'Revoke Stream Key',
  'VideoChat.CreatePopup.StreamWith.Copied': 'Copied to clipboard',
  'VideoChat.CreatePopup.StreamWith.ServerUrl': 'Server URL',
  'VideoChat.CreatePopup.StreamWith.StreamKey': 'Stream Key',
  'VideoChat.StreamRecord.Start': 'Start Recording',
  'VideoChat.StreamRecord.StopTitle': 'Stop Recording',
  'VideoChat.StreamRecord.StopDescription': 'Stop recording the audio stream?',
  'VideoChat.StreamRecord.Stop': 'Stop',
  'VideoChat.StreamRecord.Description': 'Record this stream and save the result into an file?\n\nParticipants will see that the chat is being recorded.',
  'VideoChat.StreamRecord.RecordingTitle': 'Recording Title',
  'VideoChat.StreamRecord.RecordVideo': 'Also Record Video',
  'VideoChat.StreamRecord.ChooseOrientation': 'Choose video orientation',
  'VideoChat.StreamRecord.AudioOnly': 'This chat will be recorded into an audio file',
  'VoiceChat.Chat.Livestream.Oops': 'Oops!',
  'VoiceChat.Chat.Livestream.Streaming': 'streaming',
  'VoiceChat.Chat.Livestream.Live': 'LIVE',
  'VoiceChat.Chat.Livestream.Watching': {
    'one_value': '%d watching',
    'other_value': '%d watching'
  },
  'VoiceChat.Chat.Livestream.OutputDevice': 'Output Device',
  'VoiceChat.Chat.Livestream.OutputDevice.CannotGetSource': 'Cannot get output devices',
  'VoiceChat.Chat.Livestream.OutputDevice.CannotSetSource': 'Cannot set output device',
  'VoiceChat.Chat.Livestream.StartRecording': 'Start Recording',
  'VoiceChat.Chat.Livestream.StreamSettings': 'Stream Settings',
  'VoiceChat.Chat.Livestream.EndLiveStream': 'End Live Stream',
